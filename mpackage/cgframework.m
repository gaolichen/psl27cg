...
(* Notebook to define group info for CG coefficients calculation. *)
...
If[GetRepDecorate[list[[k]]]== "" &&i<j(*GetDimensionByRep[subg,subr1[[i]]]<GetDimensionByRep[subg,subr2[[j]]]*),
